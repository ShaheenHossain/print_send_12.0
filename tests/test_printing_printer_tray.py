...
model = 'eagle.addons.base_report_to_printer.models.printing_printer'
server_model = 'eagle.addons.base_report_to_printer.models.printing_server'
...
class TestPrintingPrinter(TransactionCase):
    ...
    def test_prepare_update_from_cups_unknown_trays(self, cups):
        """
        Check that trays which are not in the PPD file are removed from Eagle
        """
        self.mock_cups_ppd(cups)
